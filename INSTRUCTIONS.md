Below is a **production-grade `INSTRUCTION.md`** you can place in the empty directory and give to **Cloud Opus 4.5** to generate the full Auth Service from scratch.

It is explicit, structured, and enforces professional architecture.
